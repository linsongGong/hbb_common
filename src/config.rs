...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(),"Xi&0823".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.208.28"];
pub const RS_PUB_KEY: &str = "upQyQxdQJOpYMTGsfPxI1scfQOERC8OfshvGPsWJt3w=";
